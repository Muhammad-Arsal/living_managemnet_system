...
@section('title', 'Ticket Priorities')
            ...
            <div class="card lms-page-card">
                <div class="card-header lms-page-header">
                    <div class="lms-page-header__copy">
                        ...
                        <h5 class="lms-page-header__title">Ticket Priorities</h5>
                        <p class="lms-page-header__subtitle">Manage the priority options shown when creating tickets.</p>
                    </div>
                    <a href="{{ route('admin.settings.ticket-priorities.create') }}" class="btn btn-primary lms-btn-add">
                            ...
                            <table class="table table-hover lms-data-table align-middle mb-0">
                                ...
                                <tbody>
                                    @foreach ($ticketPriorities as $ticketPriority)
                                        <tr>
                                            <td>
                                                <span class="lms-person__name">{{ $ticketPriority->name }}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="d-none d-md-table-cell">{{ $ticketPriority->sort_order }}</td>
                                            <td class="text-end">
                                                <div class="lms-actions justify-content-end">
                                                    <a href="{{ route('admin.settings.ticket-priorities.edit', $ticketPriority) }}" class="lms-action-btn lms-action-btn--edit">
                    ...
                    @else
                        <div class="lms-empty-state">
                            <div class="lms-empty-state__icon">
                                <i class="iconify" data-icon="bx:bx-flag"></i>
                            </div>
                            <p class="mb-3">No ticket priorities found.</p>
                            <a href="{{ route('admin.settings.ticket-priorities.create') }}" class="btn btn-primary">Create First Priority</a>
                        </div>
                    @endif
                </div>
            </div>
