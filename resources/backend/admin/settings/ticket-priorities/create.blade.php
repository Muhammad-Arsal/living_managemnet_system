...
@section('title', 'Create Ticket Priority')

@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h5 class="card-header">Create Ticket Priority</h5>
                <div class="card-body">
                    <form action="{{ route('admin.settings.ticket-priorities.store') }}" method="POST">
                        @csrf
                        <div class="row">
