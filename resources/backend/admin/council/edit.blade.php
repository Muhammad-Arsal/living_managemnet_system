            ...
            <div class="card lms-page-card mb-3">
                <div class="card-header lms-page-header">
                    <div class="lms-page-header__copy">
                        ...
                        <h5 class="lms-page-header__title">Send emails to {{ $council->name }}</h5>
                ...
                <div class="card-body">
                    <div class="lms-mail-grid">
                        <div class="lms-mail-card">
                            <div class="lms-mail-card__top">
                                ...
                                <div>
                                    ...
                                    <p class="lms-mail-card__copy">Send a fresh signed verification link to this council member.</p>
                            ...
                            <div class="lms-mail-card__action">
                                <form action="{{ route('admin.council.send-verification-email', $council) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="lms-filter-btn lms-filter-btn--primary" @disabled($council->hasVerifiedEmail())>
                                        <i class="iconify" data-icon="bx:bx-send"></i>
                                        {{ $council->hasVerifiedEmail() ? 'Already verified' : 'Send verification email' }}
                                    </button>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="lms-mail-card">
                            ...
                            <div class="lms-mail-card__action">
                                <form action="{{ route('admin.council.send-password-reset-email', $council) }}" method="POST">
                                    @csrf
                        ...
                        <div class="lms-mail-card">
                            ...
                            <div class="lms-mail-card__action">
                                <form action="{{ route('admin.council.send-welcome-email', $council) }}" method="POST">
                                    @csrf
            ...
            <div class="card lms-page-card">
                <div class="card-header lms-page-header">
                    <div class="lms-page-header__copy">
                        ...
                        <h5 class="lms-page-header__title">Edit council member</h5>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.council.update', $council) }}" method="POST">
                        ...
                        <a href="{{ route('admin.council.index') }}" class="lms-filter-btn lms-filter-btn--ghost">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
