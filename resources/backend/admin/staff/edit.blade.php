            ...
            <div class="card lms-page-card mb-3">
                <div class="card-header lms-page-header">
                    <div class="lms-page-header__copy">
                        ...
                        <h5 class="lms-page-header__title">Send emails to {{ $staff->name }}</h5>
                ...
                <div class="card-body">
                    <div class="lms-mail-grid">
                        <div class="lms-mail-card">
                            <div class="lms-mail-card__top">
                                ...
                                <div>
                                    ...
                                    <p class="lms-mail-card__copy">Send a fresh signed verification link to this staff member.</p>
                            ...
                            <div class="lms-mail-card__action">
                                <form action="{{ route('admin.staff.send-verification-email', $staff) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="lms-filter-btn lms-filter-btn--primary" @disabled($staff->hasVerifiedEmail())>
                                        <i class="iconify" data-icon="bx:bx-send"></i>
                                        {{ $staff->hasVerifiedEmail() ? 'Already verified' : 'Send verification email' }}
                                    </button>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="lms-mail-card">
                            ...
                            <div class="lms-mail-card__action">
                                <form action="{{ route('admin.staff.send-password-reset-email', $staff) }}" method="POST">
                                    @csrf
                        ...
                        <div class="lms-mail-card">
                            ...
                            <div class="lms-mail-card__action">
                                <form action="{{ route('admin.staff.send-welcome-email', $staff) }}" method="POST">
                                    @csrf
            ...
            <div class="card lms-page-card">
                <div class="card-header lms-page-header">
                    <div class="lms-page-header__copy">
                        ...
                        <h5 class="lms-page-header__title">Edit staff</h5>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.staff.update', $staff) }}" method="POST">
                        ...
                        <a href="{{ route('admin.staff.index') }}" class="lms-filter-btn lms-filter-btn--ghost">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
