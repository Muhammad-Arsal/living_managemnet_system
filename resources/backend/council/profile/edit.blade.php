    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('council.profile.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ $council->avatar_url ?: avatar_placeholder($council->initials) }}"
                                alt="Avatar"
                        ...
                        <div class="property-form-section">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ old('name', $council->name) }}" required>
                                    </div>
                                    @error('name')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            id="email" name="email" value="{{ old('email', $council->email) }}" required>
                                    </div>
                                    @error('email')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                            id="phone" name="phone" value="{{ old('phone', $council->profile?->phone) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i class="iconify" data-icon="bx:bx-buildings"></i></span>
                                        <input type="text" class="form-control @error('organization') is-invalid @enderror"
                                            id="organization" name="organization"
                                            value="{{ old('organization', $council->profile?->organization) }}">
                                    </div>
                                    @error('organization')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control @error('bio') is-invalid @enderror"
                                    ...
                                    placeholder="A short introduction">{{ old('bio', $council->profile?->bio) }}</textarea>
                                @error('bio')
                        ...
                        <div class="mt-4">
                            ...
                            <a href="{{ route('council.dashboard') }}" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
