<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item {{ request()->routeIs('council.dashboard') ? 'active' : '' }}">
            <a href="{{ route('council.dashboard') }}" class="menu-link">
                <i class="menu-icon tf-icon iconify iconify-lg" data-icon="bx:bx-home-circle"></i>
                <div>Dashboard</div>
            </a>
        </li>
        <li class="menu-item {{ request()->routeIs('council.tickets.*') ? 'active' : '' }}">
            <a href="{{ route('council.tickets.index') }}" class="menu-link">
