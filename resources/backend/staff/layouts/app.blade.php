...
<body>
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            @include('backend::staff.layouts.partials.sidebar')

            <div class="layout-page">
                @include('backend::staff.layouts.partials.navbar')

                <div class="content-wrapper">
                    <div class="container-fluid flex-grow-1 container-p-y">
                        @include('backend::staff.layouts.partials.verify-email-banner')
                        @include('backend::staff.layouts.partials.alerts')
                        @yield('content')
                    </div>

                    @include('backend::staff.layouts.partials.footer')
                </div>
            </div>
        </div>
